...
- [ ] **SIMP-02** : Un lecteur peut lire son résultat : pagination, emplacement réel des informations de calcul, correspondance des libellés abrégés à l'écran — dérivé de DOCS-04
- [ ] **SIMP-03** : Un lecteur peut sauvegarder un stuff dans son navigateur et l'exporter vers Dofusbook — dérivé de DOCS-04
