...
Plans:
- [ ] 01-01: Poser `docs/sommaire.md` (index unique, parcours conseillé) et la section « Documentation utilisateur » de `README.md`
- [ ] 01-02: Rédiger `docs/installation.md` depuis le code réel (prérequis, installation, vérification, lancement CLI et web, pilotage clavier)
- [ ] 01-03: Ajouter la fixture `docs_dir`, le helper de normalisation (testé) et `tests/test_docs_structure.py` (arbres, exhaustivité bidirectionnelle, liens relatifs, H1 ↔ libellé, UTF-8)
...
|-------|----------------|--------|-----------|
| 1. Socle documentaire, installation et harnais vérifiable | 0/4 | Not started | - |
